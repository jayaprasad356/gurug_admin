                                ...
                                <form method="post" id="shiprocket_settings_form">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control shiprocket_email" disabled name="shiprocket_email" id="shiprocket_email" value="<?= DOMAIN_URL . 'shiprocket-webhook.php' ?>" placeholder='Shiprocket Webhook url' />
                                        </div>
                                        <div class="form-group col-md-4">
