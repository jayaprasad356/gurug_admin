    ...
    foreach ($variant_data as $vari_data) {
        for ($i = 0; $i < count($vari_data['id']); $i++) {
            ...
            $tempRow = array(
                ...
                ($loose_stock != "") ? 'loose_stock' : 'stock' => ($loose_stock != "") ? $vari_data['stock'] : $vari_data['stock'],
                ($loose_stock != "") ? 'loose_stock_unit_id' : 'stock_unit_id' => ($loose_stock != "") ? $vari_data['stock_unit_id'] :  $vari_data['stock_unit_id'],
...
//         }
//     }
//     // print_r($_POST['standard_shipping']);
//     if (isset($_POST['shipping_type']) && $_POST['shipping_type'] == 'standard') {
//         $res_msg .= empty($_POST['pickup_location']) ? 'pickup_location' : "";
//     } else {
//         $res_msg .= ($_POST['delivery_places'] == "") ? "delivery_places," : "";
...
//         "seller_id" => $seller_id,
//         "subcategory_id" => $subcategory_id,
//         "subcategory_name" => (!empty($sub_category_name) && !is_null($sub_category_name)) ? $sub_category_namez[0]['name'] : "",
//         "tax_id" => $tax_id,
//         "category_id" => $category_id,
//         "category_name" => !empty($category_id) ? $fn->get_data(['name'], 'id=' . $category_id, 'category')[0]['name'] : "",
//         "description" => $description,
