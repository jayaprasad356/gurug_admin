                    ...
                    <div class="box-body">
                        ...
                        <div id="variations">
                            ...
                            <div class="box-footer">
                                <input type="submit" class="btn-primary btn" id="btnEdit" value="Update" name="btnEdit" />
                            </div>
                </form>
            </div><!-- /.box -->
        </div>
...
<script>
    ...
    $('#add_loose_variation').on('click', function() {
        ...
        html = '<div class="row"><div class="col-md-4"><div class="form-group loose_div">' +
            ...
            '<div class="col-md-2"><div class="form-group"><label>Weight <i class="text-danger">*</i></label><input type="text" name="weight_loose[]" class="form-control min_value" min="0.01" onkeyup="min_value(this)"></div></div>' +
            '<div class="col-md-2"><div class="form-group"><label>Length</label><input type="text"  name="length_loose[]" class="form-control min_value" min="0.01" onkeyup="min_value(this)"></div></div>' +
            '<div class="col-md-2"><div class="form-group"><label>Breadth</label><input type="text"  name="breadth_loose[]" class="form-control min_value" min="0.01" onkeyup="min_value(this)"></div></div>' +
            '<div class="col-md-1"><div class="form-group"><label>Height</label><input type="text" name="height_loose[]"  class="form-control min_value" min="0.01" onkeyup="min_value(this)"></div></div>' +
    ...
    $('#add_packate_variation').on('click', function() {
        html = '<div class="row"><div class="col-md-2"><div class="form-group packate_div">' +
            ...
            '<div class="col-md-2"><div class="form-group"><label>Weight <i class="text-danger">*</i></label><input type="text" name="weight[]" class="form-control min_value" onkeyup="min_value(this)"></div></div>' +
