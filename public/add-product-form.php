...
<script>
    ...
    $('#add_packate_variation').on('click', function() {
        html = '<div class="row"><div class="col-md-2"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
            ...
            '</div></div>' +
            '<div class="col-md-2"><div class="form-group"><label>Weight <i class="text-danger">*</i></label><input type="text" onkeyup="min_value(this)" name="weight[]" class="form-control "></div></div>' +
            '<div class="col-md-2"><div class="form-group"><label>Length</label><input type="text"  name="length[]" onkeyup="min_value(this)" class="form-control "></div></div>' +
            '<div class="col-md-2"><div class="form-group"><label>Breadth</label><input type="text"  name="breadth[]" onkeyup="min_value(this)" class="form-control "></div></div>' +
            '<div class="col-md-1"><div class="form-group"><label>Height</label><input type="text" name="height[]" onkeyup="min_value(this)"  class="form-control "></div></div>' +
    ...
    $('#add_loose_variation').on('click', function() {
        html = '<div class="row"><div class="col-md-4"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
            ...
            '<div class="col-md-2"><div class="form-group"><label>Length</label><input type="text"  name="length_loose[]" onkeyup="min_value(this)" class="form-control min_value"></div></div>' +
            '<div class="col-md-2"><div class="form-group"><label>Breadth</label><input type="text"  name="breadth_loose[]" onkeyup="min_value(this)" class="form-control min_value"></div></div>' +
            '<div class="col-md-1"><div class="form-group"><label>Height</label><input type="text" name="height_loose[]"  onkeyup="min_value(this)" class="form-control min_value"></div></div>' +
            '</div>';
        $('#variations').append(html);
    });
</script>
